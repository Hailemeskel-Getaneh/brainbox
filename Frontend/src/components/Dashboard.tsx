      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10 flex gap-4">
          <div className="relative flex-1">
            ...
            {searching && <Loader2 size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 animate-spin" />}
          </div>
        </div>
          ...
          <>
            <div className="relative mb-10">
              ...
              {topicSearchTerm && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-300"
                >
                  &times;
                </button>
              )}
            ...
            <form onSubmit={handleCreateTopic} className="mb-10 flex gap-4">
              <input
                ...
                className="flex-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white"
              />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {topics.map((topic) => (
                  <div
                    ...
                    className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-xl p-6 cursor-pointer group transition hover:scale-[1.02]"
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex gap-2 items-center">
                        {editingTopicId === topic.id ? (
                          <>
                            ...
                            <button
                              ...
                              className="px-3 py-1 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-400 dark:hover:text-gray-300 hover:bg-gray-400/10"
                            >
                              Cancel
                            </button>
                          </>
                          ...
                          <button
                            ...
                            className="text-gray-500 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 p-1 rounded-full hover:bg-blue-400/10"
                          >
                            <Edit size={16} />
                          </button>
                        )}
                        <button
                          ...
                          className="text-gray-500 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 p-1 rounded-full hover:bg-red-400/10"
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
