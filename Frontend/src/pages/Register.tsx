        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">Join BrainBox</h1>
                    <p className="text-blue-200">Create your account and start organizing</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    type="text"
                                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-200"
                                    placeholder="johndoe"
                                    value={username}
                    ...
                    <Link
                        to="/login"
                        className="block w-full py-3 px-4 bg-white/5 border border-white/20 text-white font-semibold rounded-xl text-center hover:bg-white/10 transition-all duration-200"
                    >
                        Sign In Instead
                    </Link>
                </div>
